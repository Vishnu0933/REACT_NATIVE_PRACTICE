...
const APICrudOperation = () => {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <Modal visible={openAddDialog} transparent={true}>
        <AddUserModal
...
const AddUserModal = props => {
  ...
  return (
    <View style={styles.centeredView}>
      <View style={styles.modalView}>
        <Text style={{fontSize: 30, paddingBottom: 10, fontWeight: 700}}>
          Add new User
        </Text>
        <TextInput
          style={styles.input}
        ...
        <View style={{marginBottom: 15}}>
          <Button title="Add Data" color="green" onPress={saveData} />
        </View>
        <Button title="close" onPress={() => props.setOpenAddDialog(false)} />
      </View>
    </View>
  );
};
...
export default APICrudOperation;
